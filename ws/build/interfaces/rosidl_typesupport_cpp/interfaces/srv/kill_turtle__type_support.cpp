...
static const _KillTurtle_Request_type_support_symbol_names_t _KillTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, KillTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::KillTurtle_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, KillTurtle_Request)() {
  return get_message_type_support_handle<interfaces::srv::KillTurtle_Request>();
}
...
static const _KillTurtle_Response_type_support_symbol_names_t _KillTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, KillTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::KillTurtle_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, KillTurtle_Response)() {
  return get_message_type_support_handle<interfaces::srv::KillTurtle_Response>();
}
...
static const _KillTurtle_type_support_symbol_names_t _KillTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, KillTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::KillTurtle_service_type_support_handle;
}
