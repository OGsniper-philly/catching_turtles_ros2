...
{
  new (message_memory) interfaces::srv::KillTurtle_Request(_init);
}

void KillTurtle_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::KillTurtle_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KillTurtle_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::KillTurtle_Request, name),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KillTurtle_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::KillTurtle_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::KillTurtle_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::KillTurtle_Request_message_type_support_handle;
}
...
void KillTurtle_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::KillTurtle_Response(_init);
}

void KillTurtle_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::KillTurtle_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KillTurtle_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::KillTurtle_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KillTurtle_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::KillTurtle_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::KillTurtle_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::KillTurtle_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers KillTurtle_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::KillTurtle>()
...
get_service_type_support_handle<interfaces::srv::KillTurtle>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::KillTurtle_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::interfaces::srv::KillTurtle_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::interfaces::srv::KillTurtle_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, KillTurtle)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::KillTurtle>();
}
