...
class Metaclass_KillTurtle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _kill_turtle
...
class KillTurtle(metaclass=Metaclass_KillTurtle):
    from interfaces.srv._kill_turtle import KillTurtle_Request as Request
    from interfaces.srv._kill_turtle import KillTurtle_Response as Response
