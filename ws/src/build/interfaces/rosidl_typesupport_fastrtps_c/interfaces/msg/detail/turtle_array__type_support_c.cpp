...
#include "interfaces/msg/detail/turtle__functions.h"  // alive_turtles
  ...
  // Field name: alive_turtles
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, msg, Turtle
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: alive_turtles
  {
    ...
    if (ros_message->alive_turtles.data) {
      interfaces__msg__Turtle__Sequence__fini(&ros_message->alive_turtles);
    }
    if (!interfaces__msg__Turtle__Sequence__init(&ros_message->alive_turtles, size)) {
